...
contains
  ...
  !     do icol=1,this%ns
  !       this%blade(ib)%wiP(1,icol)%dLift=this%blade(ib)%wiP(1,icol)%meanSpan*this%blade(ib)%wiP(1,icol)%alpha
  !       this%blade(ib)%thrust=this%blade(ib)%thrust+this%blade(ib)%wiP(1,icol)%dLift
  !     enddo
  !     dyn_pressure=0.5_dp*density*this%chord*((this%radius*this%omegaSlow)**2._dp)
