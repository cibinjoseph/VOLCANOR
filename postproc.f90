...
contains
  ...
  subroutine lift2file(wing_array,filename,extra_params)
    ...
    enddo
    open(unit=10,file=filename,position='append')
    write(10,*) extra_params(1),lift!,lift/(0.5_dp*1.2_dp*extra_params(4)**2._dp*extra_params(2)*extra_params(3))
    close(10)
  ...
  subroutine drag2file(wing_array,filename,extra_params)
    ...
    enddo
    open(unit=10,file=filename,position='append')
    write(10,*) extra_params(1),drag!,drag/(0.5_dp*1.2_dp*extra_params(4)**2._dp*extra_params(2)*extra_params(3))
    close(10)
